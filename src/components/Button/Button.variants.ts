...
export const buttonCSS = (theme: Theme, variant: ButtonVariant, iconOnly?: boolean) => {
  ...
  return css({
    ...
    "&:hover:not(:disabled),&.hover:not(:disabled)": {
      background: (variant.endsWith("-ghost") && !iconOnly) ? "transparent" : btnStyles.hover.background,
      borderColor: (variant.endsWith("-ghost") && !iconOnly) ? "transparent" : btnStyles.hover.border,
    ...
    "&:active:not(:disabled),&.active:not(:disabled)": {
      background: (variant.endsWith("-ghost") && !iconOnly) ? "transparent" : btnStyles.pressed.background,
      borderColor: (variant.endsWith("-ghost") && !iconOnly) ? "transparent" : btnStyles.pressed.border,
      textDecoration: variant.endsWith("-ghost") ? "underline" : "none",
